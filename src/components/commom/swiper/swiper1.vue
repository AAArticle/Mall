<template>
  <div id="main-swiper">
    <div class="swiper"   @click="clickEvent">
      <!-- 此处插槽为放置插槽内容的位置 -->
      <slot></slot>
    </div>
    ...
    methods: {
      ...
      startTimer: function() {
        this.playTimer = window.setInterval(() => {
          this.currentIndex++;
          this.showIndicator(-this.currentIndex * this.totalWidth)
        }, this.interval)
      },
      stopTimer: function() {
      ...
      checkPosition: function() {
        window.setInterval(() => {
          //1.校验正确的位置
          this.swiperStyle.transiton = "0ms";
